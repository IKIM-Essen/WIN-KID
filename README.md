...
- The"<" ">" are removed from the VITEK files and directly compared with the EUCAST values. Is that appropriate? Should we treat all "<" Values as "0" (See Trimethoprim/Sulfamethoxazol )
