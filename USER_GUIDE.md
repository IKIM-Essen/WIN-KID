...
- Run `python workflow/controller.py resources/settings/DataPaths_predict.csv`
...
- Train and Test:
  ...
  - Run `python workflow/controller.py resources/settings/DataPaths.csv`
...
- The starting point is the class `controller.py` which is used as follows:
`python workflow/controller.py resources/settings/DataPaths_local.csv`
